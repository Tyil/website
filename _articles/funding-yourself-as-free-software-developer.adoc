...
What I'm also missing here is a rewards system. Most other platforms allow you
to set reward tiers, which allow you to give certain benefits to donors.
LiberaPay does not seem to offer this.
...
// @FIXME Seems a tad short

=== Using the rewards system
On the platforms that support a rewards system, make use of it. There's some
little things you can do that go a long way with your supporters.

For instance, you can offer things like stickers to donors that donate a
certain amount of money to you. These are reasonably cheap to produce and ship,
...
this, but most free software enthousiasts are already on IRC, and there's
little real-time communication alternatives that they're already using.
