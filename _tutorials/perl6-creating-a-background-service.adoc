...
== It's not possible!
After a lot of trying and talking with the folks at #perl6 I was told that it
is not possible to do this in pure Perl 6, explained by people with more
knowledge than I have on the internals:
